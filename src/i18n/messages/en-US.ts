export default {
  ...
  pages: {
    ...
    settings: {
      ...
      secretWillBeClearedPlaceholder: 'Will be cleared after saving',
      clearSavedSecret: 'Clear saved value on save',
      ...
      envSettingsHint: 'Gateway will reconnect automatically after changing OpenClaw URL or Token. Sensitive fields are never shown; blank values keep the current secret and the checkbox explicitly clears it.',
    },
    tools: {
      title: 'Tools',
